...
void SDIO_ClockCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) CLKCR_CLKEN_BB = (uint32_t)NewState;
}
...
void SDIO_StartSDIOReadWait(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) DCTRL_RWSTART_BB = (uint32_t) NewState;
}
...
void SDIO_StopSDIOReadWait(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) DCTRL_RWSTOP_BB = (uint32_t) NewState;
}
...
void SDIO_SetSDIOReadWaitMode(uint32_t SDIO_ReadWaitMode)
{
  ...
  *(volatile uint32_t *) DCTRL_RWMOD_BB = SDIO_ReadWaitMode;
}
...
void SDIO_SetSDIOOperation(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) DCTRL_SDIOEN_BB = (uint32_t)NewState;
}
...
void SDIO_SendSDIOSuspendCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) CMD_SDIOSUSPEND_BB = (uint32_t)NewState;
}
...
void SDIO_CommandCompletionCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) CMD_ENCMDCOMPL_BB = (uint32_t)NewState;
}
...
void SDIO_CEATAITCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) CMD_NIEN_BB = (uint32_t)((~((uint32_t)NewState)) & ((uint32_t)0x1));
}
...
void SDIO_SendCEATACmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) CMD_ATACMD_BB = (uint32_t)NewState;
}
...
void SDIO_DMACmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) DCTRL_DMAEN_BB = (uint32_t)NewState;
}
